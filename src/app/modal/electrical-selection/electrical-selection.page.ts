...
@Component({
  ...
  templateUrl: './electrical-selection.page.html',
  styleUrls: ['./electrical-selection.page.scss'],
  providers: [FormBuilder],
})
export class ElectricalSelectionPage implements OnInit {
  PreviewPDF = false;
  inspectionTypes: any = [];
  ...
  electricalObservationRecommendations: any;
  CompSelect1 = true;
  ...
  constructor(
    ...
    this.inspectionTypes = [
      ...
      {
        name: 'Electrical System Description',

        val: '1',
      },
      {
        name: 'Electrical Observation',
  ...
  ionViewDidEnter() {
    ...
    if (StorageDate != undefined) {
      ...
      if (this.StoredData['electricalDescription'] != undefined) {
        this.added_items = this.StoredData['electricalDescription'];
      }

      if (this.StoredData['electricalObservation'] != undefined) {
        this.added_items2 = this.StoredData['electricalObservation'];
      }
      ...
      if (
        this.StoredData['electricalObservationRecommendations'] != undefined
      ) {
        this.added_items3 = this.StoredData[
          'electricalObservationRecommendations'
        ];
      }
    }
  }
  ...
  updateDescription() {
    ...
    console.log(
      'To finalize electricalDescription=====' + electricalDescription
    );

    if (electricalDescription != undefined) {
      if (this.added_items == '') {
        this.added_items = [];
      ...
      let arr3 = [...electricalDescription, ...newArray];
    ...
    if (electricalDescription == null || electricalDescription == undefined) {
      ...
      var ObArr = {
        electricalDescription: [this.added_items],
      };
      ...
      this.StoredData.electricalDescription = newArray;
  ...
  updateDescription2() {
    ...
    if (electricalObservation == null || electricalObservation == undefined) {
      ...
      this.StoredData.electricalObservation = newArray;
  ...
  updateDescription3() {
    ...
    console.log('To finalize electricalDescription=====' + structureComments);
    ...
    if (structureComments == null || structureComments == undefined) {
      ...
      this.StoredData.electricalObservationRecommendations = newArray;
  ...
  updateDescription5() {
    ...
    if (structureLimitations == null || structureLimitations == undefined) {
      ...
      this.StoredData.D2electricalServiceEntryGroundStructure = newArray;
  ...
  updateDescription6() {
    ...
    if (structureLimitations == null || structureLimitations == undefined) {
      ...
      this.StoredData.D2electricalMainDisconnectStructure = newArray;
  ...
  updateDescription7() {
    ...
    if (structureLimitations == null || structureLimitations == undefined) {
      ...
      this.StoredData.D2electricalDistributionPanelStructure = newArray;
  ...
  updateDescription8() {
    ...
    if (structureLimitations == null || structureLimitations == undefined) {
      ...
      this.StoredData.D2electricalAuxilliaryStructureStructure = newArray;
  ...
  updateDescription9() {
    ...
    if (structureLimitations == null || structureLimitations == undefined) {
      ...
      this.StoredData.D2electricalWiringStructureStructure = newArray;
  ...
  updateDescription10() {
    ...
    if (structureLimitations == null || structureLimitations == undefined) {
      ...
      this.StoredData.D2electricalGroundFaultStructureStructure = newArray;
